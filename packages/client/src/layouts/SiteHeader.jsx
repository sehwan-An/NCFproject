    ...
    <div>
      <Container className="header-container" fluid>
        <div className="d-flex justify-content-between py-3">
          <div className='posi-rel'>
            <NavLink to='/'><img src={Logo} alt="logo" className='logo-size' /></NavLink>
          </div>
          <div className="user-navi-bar posi-rel">
            {userInfo ? (
              <div className='posi-rel d-flex align-items-center gap-3'>
        ...
        <nav className="d-flex justify-content-center gap-5 py-2 posi-rel">
